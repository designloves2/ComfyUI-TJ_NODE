...
**TJ_MultiRouter** node has been added to provide flexible branching and routing for complex workflows.

### Key Features

* **Dynamic Port Expansion**: Automatically adds input/output ports based on connections, supporting up to 20 slots.
    * *입력을 연결하면 포트가 자동으로 확장되며, 최대 20개의 입/출력 슬롯을 지원합니다.*
* **Dual Operation Modes**: 
    * **Dynamic (Auto)**: Synchronizes ports in real-time based on active connections.
    * **Manual**: Allows the user to fix the number of ports as needed.
    * *Dynamic 모드는 연결 개수에 맞춰 포트를 실시간 동기화하며, Manual 모드는 사용자가 포트 개수를 직접 지정할 수 있습니다.*
* **UI Optimization**: Optimized for a clean, compact interface by removing unnecessary spacing.
    * *불필요한 여백을 제거하여 노드 레이아웃의 가독성과 효율성을 극대화했습니다.*
* **Connection Safety**: Uses ComfyUI's wildcard (`*`) type to ensure stable routing for any data type.
    * *ComfyUI 와일드카드(`*`) 타입을 사용하여 데이터 타입에 관계없이 안정적인 라우팅을 보장합니다.*
...
<img width="1741" height="837" alt="스크린샷 2026-05-28 오후 2 56 25" src="https://github.com/user-attachments/assets/ce20c91c-9129-402c-b910-4939250c6da2" />
...
<img width="1553" height="1029" alt="스크린샷 2026-05-28 오후 3 05 55" src="https://github.com/user-attachments/assets/63de46d4-9e2b-4af6-b6c5-aaa35cc458f6" />
...
* **TJ_MultiRouter**: 입력을 연결하면 포트가 자동으로 확장되며, 최대 20개의 입/출력 슬롯을 지원합니다.
   * A node has been added to provide flexible branching and routing for complex workflows.
<img width="1504" height="651" alt="스크린샷 2026-05-28 오후 3 08 08" src="https://github.com/user-attachments/assets/e084d5c4-3edc-44fb-b78d-e1d57fdef77e" />
...
<img width="50%" height="50%" alt="스크린샷 2026-05-28 오후 2 57 11" src="https://github.com/user-attachments/assets/51311568-aa6d-471e-82e2-de01b8939aaf" /><img width="50%" height="50%" alt="스크린샷 2026-05-28 오후 2 56 42" src="https://github.com/user-attachments/assets/100c923b-5d12-4407-b3f1-b1f2faf8f7fe" />
