# nodes/etc/time_segment_list.py
...
class TimeSegmentListNode:
    ...
    def INPUT_TYPES(cls):
        return {
            "required": {
                "start_sec": ("INT", {"default": 0, "min": 0, "max": 999999, "step": 1}),
                "duration_sec": ("INT", {"default": 20, "min": 1, "max": 999999, "step": 1}),
                "total_sec": ("INT", {"default": 120, "min": 1, "max": 999999, "step": 1}),
            },
            "optional": {
                "overlap_sec": ("INT", {"default": 3, "min": 0, "max": 999999, "step": 1}),
                "include_over_total": (["true", "false"], {"default": "true"}),
                "format_mode": (["range_only", "with_formula", "csv"], {"default": "with_formula"}),
            },
        }

    def make_segments(self, start_sec, duration_sec, total_sec,
                      overlap_sec=3, include_over_total="true", format_mode="with_formula"):
