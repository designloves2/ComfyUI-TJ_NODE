...
class TJ_ZImageTurbo:
    ...
    def INPUT_TYPES(cls):
        ...
        base = {
            "required": {
                "model_name": (model_names, {"default": _first_existing(model_names, ["", ""])}),
                "clip_name": (clip_names, {"default": _first_existing(clip_names, ["", ""])}),
    ...
    def generate(self, model_name, clip_name, vae_name, positive, negative,
                 ...
                 get_name="(none)", auto_set=False, image=None, width=0, height=0,
