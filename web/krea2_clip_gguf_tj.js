...
const NODE_CLASS = "TJ_NODE_Krea2ClipLoaderGGUF";
...
function updateAutoSets(node) {
    ...
    const base = String(setW?.value || node.title || "Krea2_CLIP").trim();
