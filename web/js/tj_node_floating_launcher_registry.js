// TJ_NODE Floating Launcher Registry - TEST
// Easy edit file.
// Add / remove / move nodes here only.

export const TJ_LAUNCHER_CATEGORIES = [
  "Wireless",
  "Utility",
  "Image",
  "Preview",
...
export const TJ_QUICK_NODES = [
  "Set Node (TJ)",
  "Get Node (TJ)",
  "Multi Get Node (TJ)"
];

export const TJ_LAUNCHER_NODES = [
  // Wireless
  { category: "Wireless", title: "Set Node (TJ)", type: "Set Node (TJ)" },
  ...
  { category: "Utility", title: "Prompt Text (TJ)", type: "Prompt Text (TJ)" },
  { category: "Utility", title: "Smart Converter (TJ)", type: "Smart Converter (TJ)" },
  ...
  { category: "Preview", title: "Smart show (TJ)", type: "Smart show (TJ)" },
