// web/tj_skin_retouch.js
// Skin Retouch (TJ) — embedded get/set binding.
// Same minimal recipe as tj_rtx_effects.js: get_name bound to the single "images"
// input, setnode_name syncs the provider name. No auto_set — single IMAGE output,
// a plain embedded Set covers it.

import { app } from "../../scripts/app.js";

const NODE_TYPES = new Set(["TJ_SkinRetouch"]);
...
app.registerExtension({
    name: "TJ.SkinRetouch.EmbeddedGet",
